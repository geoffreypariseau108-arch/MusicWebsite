                  ...
                  {product.name.toLowerCase().includes('reimagine') ? (
                    <>
                      ...
                      <div className="flex items-center justify-center space-x-4 pt-4 border-t border-slate-700">
                        ...
                        >
                          <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                            <path fill="#FA243C" d="M23.994 6.124a8.23 8.23 0 0 0-.24-2.01c-.317-1.28-1.126-2.304-2.4-2.958A8.466 8.466 0 0 0 19.4.488c-.88-.184-1.782-.264-2.685-.278-.993-.016-1.987-.017-2.98-.017s-1.987 0-2.98.017c-.903.014-1.804.094-2.685.278a8.466 8.466 0 0 0-1.954.668c-1.274.654-2.083 1.678-2.4 2.958a8.23 8.23 0 0 0-.24 2.01c-.033.924-.033 1.848-.033 2.772v6.208c0 .924 0 1.848.033 2.772a8.23 8.23 0 0 0 .24 2.01c.317 1.28 1.126 2.304 2.4 2.958a8.466 8.466 0 0 0 1.954.668c.88.184 1.782.264 2.685.278.993.016 1.987.017 2.98.017s1.987 0 2.98-.017c.903-.014 1.804-.094 2.685-.278a8.466 8.466 0 0 0 1.954-.668c1.274-.654 2.083-1.678 2.4-2.958a8.23 8.23 0 0 0 .24-2.01c.033-.924.033-1.848.033-2.772V8.896c0-.924 0-1.848-.033-2.772zM16.123 14.184c-.151.58-.456 1.063-.924 1.449-.47.388-1.015.628-1.621.723-.524.081-1.053.094-1.58.094-.528 0-1.057-.013-1.58-.094-.606-.095-1.15-.335-1.622-.723-.467-.386-.772-.869-.923-1.449-.13-.499-.144-1.013-.144-1.525 0-.511.014-1.025.144-1.524.151-.58.456-1.063.923-1.449.471-.388 1.016-.628 1.622-.723.523-.081 1.052-.094 1.58-.094.527 0 1.056.013 1.58.094.606.095 1.15.335 1.621.723.468.386.773.869.924 1.449.13.499.144 1.013.144 1.524 0 .512-.014 1.026-.144 1.525zm-.635-5.849a1.118 1.118 0 0 1-1.09.87 1.112 1.112 0 0 1-1.09-.87 3.346 3.346 0 0 0-.486-1.051 3.335 3.335 0 0 0-.852-.77c-.452-.289-.958-.468-1.49-.531a1.112 1.112 0 0 1-.87-1.09c0-.547.393-1.012.92-1.09a6.165 6.165 0 0 1 2.735.532 6.15 6.15 0 0 1 2.204 1.764c.445.583.783 1.258.963 1.987a1.112 1.112 0 0 1-.87 1.09 1.118 1.118 0 0 1-.074.159z"/>
                          </svg>
                        </a>
                        <a
                          href="https://music.apple.com/us/album/reimagine-reimagine/1853165814"
